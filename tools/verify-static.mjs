...
const assertions = [
  ...
  [serviceWorker.includes("memory-foundry-shell-v1.2.0"), "service worker cache version is missing"],
  [serviceWorker.includes("src/library.js?v=1.2.0"), "service worker must cache the library module"],
