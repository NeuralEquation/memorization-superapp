...
const assertions = [
  ...
  [serviceWorker.includes("memory-foundry-shell-v1.4.0"), "service worker cache version is missing"],
  [serviceWorker.includes("src/library.js?v=1.4.0"), "service worker must cache the library module"],
  [serviceWorker.includes("src/constitution-mock.js?v=1.4.0"), "service worker must cache the constitution mock module"],
