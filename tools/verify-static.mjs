...
const assertions = [
  ...
  [serviceWorker.includes("memory-foundry-shell-v1.1.4"), "service worker cache version is missing"],
  [serviceWorker.includes("src/library.js?v=1.1.4"), "service worker must cache the library module"],
